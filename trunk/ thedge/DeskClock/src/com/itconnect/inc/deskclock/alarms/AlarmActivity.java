...
import com.itconnect.inc.deskclock.widget.multiwaveview.GlowPadView;
...
public class AlarmActivity extends Activity {
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.itconnect.inc.deskclock.ALARM_SNOOZE";

    // AlarmActivity listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.itconnect.inc.deskclock.ALARM_DISMISS";
