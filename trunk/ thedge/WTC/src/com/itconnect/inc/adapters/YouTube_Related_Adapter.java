...
public class YouTube_Related_Adapter extends BaseAdapter {
	...
	public YouTube_Related_Adapter(Context context, ArrayList<Video> v) {
		mContext = context;
		videolist = v;
	...
	public View getView(final int position, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			arg1 = mInflater.inflate(R.layout.related_videos_item, null);
			vh = new ViewHolder();
			vh.tv = (TextView) arg1.findViewById(R.id.video_title);
//			vh.description= (TextView) arg1.findViewById(R.id.show_description);
			vh.iv = (ImageView) arg1.findViewById(R.id.thumbnail_image);
