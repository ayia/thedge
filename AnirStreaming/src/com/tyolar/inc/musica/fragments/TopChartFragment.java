...
public class TopChartFragment extends FCFragment{
	View search_view;
	public TopChartFragment(String titel) {
		super(titel);
	...
	private void startsearch() {
		new Discover_json(this.getActivity(),search_view).execute(new apiurls().getTopchart());
	}
